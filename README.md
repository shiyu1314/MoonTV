...
```bash
# 拉取预构建镜像
docker pull ghcr.io/shiyu1314/moontv:latest

# 运行容器
# -d: 后台运行  -p: 映射端口 3000 -> 3000
docker run -d --name moontv -p 3000:3000 --env PASSWORD=your_password ghcr.io/shiyu1314/moontv:latest
```
...
services:
  moontv:
    image: ghcr.io/shiyu1314/moontv:latest
